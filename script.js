...
const translations = {
  en: {
    ...
    footerText: "Online conversation clubs in English, French and Spanish.",
...
function applyLanguage(language) {
  ...
  localStorage.setItem("emiliatalkLanguage", language);
}
