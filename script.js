...
const translations = {
  en: {
    ...
    heroText: "Friendly online conversation clubs in English, French, Spanish and Russian. Small groups of 3–4 people, so everyone gets time to speak.",
    ...
    russianText: "Develop confidence and fluency through real conversation in Russian.",
    ...
    aboutText1: "English is Emilia\'s native language. She speaks Russian, French and Spanish at a high level.",
    ...
    footerText: "Conversation clubs in English, French, Spanish and Russian.",
  ...
  ru: {
    ...
    heroText: "Дружелюбные разговорные клубы английского, французского, испанского и русского. В группе только 3–4 человека, поэтому говорит каждый.",
    viewClubs: "Посмотреть клубы", trialButton: "Записаться на пробное",
    people: "человека в группе", session: "одно занятие", price: "за занятие", languages: "языка",
    ...
    russianText: "Развивайте уверенность и беглость речи через живое общение на русском.",
    ...
    aboutText1: "Английский для Эмилии родной. Русским, французским и испанским она владеет на высоком уровне.",
    ...
    footerText: "Разговорные клубы английского, французского, испанского и русского.",
  ...
  fr: {
    navClubs:"Clubs",navAbout:"À propos",eyebrow:"Clubs de conversation en ligne",heroTitle:"Parlez davantage. Gagnez en confiance.",heroText:"Clubs de conversation en anglais, français, espagnol et russe. Petits groupes de 3 à 4 personnes.",viewClubs:"Voir les clubs",trialButton:"Réserver un essai",people:"personnes par groupe",session:"séance de conversation",price:"par séance",languages:"langues",chooseClub:"Choisissez votre club",clubsTitle:"Pratique orale simple",clubsIntro:"Pas de niveaux compliqués. Un petit groupe, un sujet intéressant et une vraie conversation.",englishText:"Parlez de voyages, culture, films, études et vie quotidienne.",frenchText:"Pratiquez un français naturel autour de la culture et du voyage.",spanishText:"Parlez de voyages, nourriture, films et situations quotidiennes.",russianText:"Développez votre aisance grâce à de vraies conversations en russe.",smallGroups:"Petits groupes",realTopics:"Sujets de la vie réelle",friendlyFeedback:"Retour bienveillant",bookPlace:"Réserver une place",aboutEyebrow:"À propos d’Emilia",aboutTitle:"Une animatrice multilingue",aboutText1:"L’anglais est la langue maternelle d’Emilia. Elle parle russe, français et espagnol à un niveau élevé.",aboutText2:"Elle a publié des livres pour enfants et crée un espace convivial pour parler naturellement.",ctaTitle:"Commencez par une conversation.",ctaText:"Choisissez une langue et réservez une séance d’essai.",footerText:"Clubs de conversation en anglais, français, espagnol et russe.",formEyebrow:"Demande d’inscription",formTitle:"Réservez votre place",nameLabel:"Nom",clubLabel:"Langue",messageLabel:"Message (facultatif)",sendRequest:"Envoyer",formNote:"Votre application e-mail s’ouvrira avec la demande préparée."
  },
  es: {
    navClubs:"Clubes",navAbout:"Sobre Emilia",eyebrow:"Clubes de conversación online",heroTitle:"Habla más. Gana confianza.",heroText:"Clubes de conversación en inglés, francés, español y ruso. Grupos pequeños de 3 a 4 personas.",viewClubs:"Ver clubes",trialButton:"Reservar prueba",people:"personas por grupo",session:"sesión de conversación",price:"por clase",languages:"idiomas",chooseClub:"Elige tu club",clubsTitle:"Práctica oral sencilla",clubsIntro:"Sin niveles complicados. Un grupo pequeño, un tema interesante y conversación real.",englishText:"Habla sobre viajes, cultura, películas, estudios y vida diaria.",frenchText:"Practica francés natural con cultura, viajes y temas cotidianos.",spanishText:"Habla sobre viajes, comida, películas y situaciones reales.",russianText:"Desarrolla fluidez y confianza mediante conversaciones reales en ruso.",smallGroups:"Grupos pequeños",realTopics:"Temas de la vida real",friendlyFeedback:"Comentarios amables",bookPlace:"Reservar plaza",aboutEyebrow:"Sobre Emilia",aboutTitle:"Una anfitriona multilingüe",aboutText1:"El inglés es la lengua materna de Emilia. Habla ruso, francés y español a un nivel alto.",aboutText2:"Ha publicado libros infantiles y crea un espacio cómodo para hablar con naturalidad.",ctaTitle:"Empieza con una conversación.",ctaText:"Elige un idioma y reserva una sesión de prueba.",footerText:"Clubes de conversación en inglés, francés, español y ruso.",formEyebrow:"Solicitud de inscripción",formTitle:"Reserva tu plaza",nameLabel:"Nombre",clubLabel:"Idioma",messageLabel:"Mensaje (opcional)",sendRequest:"Enviar",formNote:"Se abrirá tu aplicación de correo con la solicitud preparada."
  }
};
